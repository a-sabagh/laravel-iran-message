...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | IRMessage Package message bodies (irmessage.{driver}.lang)
    |--------------------------------------------------------------------------
    |
    | The following language lines are used as message body of each driver
    | For example for ippanel driver message bodies are pattern, you can pass
